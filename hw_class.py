...
class Pants(object):
    ...
    def discount(self, discount_ratio: float):
        return self.price * (1-discount_ratio)


class SalesPerson(object):
    def __init__(self, first_name, last_name, employee_id, salary) -> None:
        super().__init__()
...
class Gaussian():
    ...
    def calculate_stdev(self, sample=True):
        ...
        if len(self.data) != 0:
            ...
            for value in self.data:
                new_value = (value - avg)**2
                accumulate += new_value
            sigma = math.sqrt(accumulate/len(self.data))
        self.stdev = sigma
        return sigma
    ...
    def plot_histogram(self):
        ...
        plt.xlabel("value")
        plt.ylabel("counts")
        plt.title("Hist of Gaussian distribution")
